...
3. The light novel is specified as being such by the original publisher or the majority of major Japanese retailers; _**or**_ published under one of our [approved light novel labels](./lightnovellabels.html#general-labels).
